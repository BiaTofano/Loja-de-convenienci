    ...
    while(1){
        ...
        if(opt1 == 1){ // opção: Sim
            ...
            while(1){
                ...
                printf("2 - Produto 2\t R$ 15,00\n");
                printf("3 - Produto 3\t R$ 13,00\n");
                printf("4 - Produto 4\t R$ 12,00\n");
                printf("5 - Produto 5\t R$ 19,00\n");
                printf("6 - Produto 6\t R$ 17,00\n");
                printf("7 - Produto 7\t R$ 20,00\n");
                printf("8 - Produto 8\t R$ 30,00\n");
                printf("9 - Produto 9\t R$ 8,00\n");
